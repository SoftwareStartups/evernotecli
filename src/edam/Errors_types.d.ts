 ...
 */
declare enum EDAMInvalidContactReason {
  BAD_ADDRESS = 0,
  DUPLICATE_CONTACT = 1,
  NO_CONNECTION = 2,
}
...
declare class EDAMUserException extends Thrift.TException {
  public errorCode: EDAMErrorCode;
 ...
 * </dl>
 */
declare class EDAMInvalidContactsException extends Thrift.TException {
  public contacts: Types_ttypes.Contact[];
  public parameter?: string;
  public reasons?: EDAMInvalidContactReason[];

    constructor(args?: { contacts: Types_ttypes.Contact[]; parameter?: string; reasons?: EDAMInvalidContactReason[]; });
}
