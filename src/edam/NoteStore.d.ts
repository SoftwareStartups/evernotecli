...
import ttypes = require('./NoteStore_types');
import ShareRelationshipPrivilegeLevel = ttypes.ShareRelationshipPrivilegeLevel
import SyncState = ttypes.SyncState
import SyncChunk = ttypes.SyncChunk
import SyncChunkFilter = ttypes.SyncChunkFilter
import NoteFilter = ttypes.NoteFilter
import NoteList = ttypes.NoteList
import NoteMetadata = ttypes.NoteMetadata
import NotesMetadataList = ttypes.NotesMetadataList
import NotesMetadataResultSpec = ttypes.NotesMetadataResultSpec
import NoteCollectionCounts = ttypes.NoteCollectionCounts
import NoteResultSpec = ttypes.NoteResultSpec
import NoteEmailParameters = ttypes.NoteEmailParameters
import NoteVersionId = ttypes.NoteVersionId
import RelatedQuery = ttypes.RelatedQuery
import RelatedResult = ttypes.RelatedResult
import RelatedResultSpec = ttypes.RelatedResultSpec
import UpdateNoteIfUsnMatchesResult = ttypes.UpdateNoteIfUsnMatchesResult
import ShareRelationshipRestrictions = ttypes.ShareRelationshipRestrictions
import InvitationShareRelationship = ttypes.InvitationShareRelationship
import MemberShareRelationship = ttypes.MemberShareRelationship
import ShareRelationships = ttypes.ShareRelationships
import ManageNotebookSharesParameters = ttypes.ManageNotebookSharesParameters
import ManageNotebookSharesError = ttypes.ManageNotebookSharesError
import ManageNotebookSharesResult = ttypes.ManageNotebookSharesResult
import SharedNoteTemplate = ttypes.SharedNoteTemplate
import NotebookShareTemplate = ttypes.NotebookShareTemplate
import CreateOrUpdateNotebookSharesResult = ttypes.CreateOrUpdateNotebookSharesResult
import NoteShareRelationshipRestrictions = ttypes.NoteShareRelationshipRestrictions
import NoteMemberShareRelationship = ttypes.NoteMemberShareRelationship
import NoteInvitationShareRelationship = ttypes.NoteInvitationShareRelationship
import NoteShareRelationships = ttypes.NoteShareRelationships
import ManageNoteSharesParameters = ttypes.ManageNoteSharesParameters
import ManageNoteSharesError = ttypes.ManageNoteSharesError
import ManageNoteSharesResult = ttypes.ManageNoteSharesResult
...
declare class Client {
   ...
   */
  getSyncState(authenticationToken: string): SyncState;

  /**
   * Asks the NoteStore to provide information about the status of the user
   * account corresponding to the provided authentication token.
   */
  getSyncState(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: SyncState)=>void): void;
   ...
   * </ul>
   */
  getFilteredSyncChunk(authenticationToken: string, afterUSN: number, maxEntries: number, filter: SyncChunkFilter): SyncChunk;
   ...
   * </ul>
   */
  getFilteredSyncChunk(authenticationToken: string, afterUSN: number, maxEntries: number, filter: SyncChunkFilter, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: SyncChunk)=>void): void;
   ...
   * </ul>
   */
  getLinkedNotebookSyncState(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook): SyncState;
   ...
   * </ul>
   */
  getLinkedNotebookSyncState(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: SyncState)=>void): void;
   ...
   * </ul>
   */
  getLinkedNotebookSyncChunk(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook, afterUSN: number, maxEntries: number, fullSyncOnly: boolean): SyncChunk;
   ...
   * </ul>
   */
  getLinkedNotebookSyncChunk(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook, afterUSN: number, maxEntries: number, fullSyncOnly: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: SyncChunk)=>void): void;

  /**
   * Returns a list of all of the notebooks in the account.
   */
  listNotebooks(authenticationToken: string): Types_ttypes.Notebook[];

  /**
   * Returns a list of all of the notebooks in the account.
   */
  listNotebooks(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.Notebook[])=>void): void;
   ...
   * </ul>
   */
  listAccessibleBusinessNotebooks(authenticationToken: string): Types_ttypes.Notebook[];
   ...
   * </ul>
   */
  listAccessibleBusinessNotebooks(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.Notebook[])=>void): void;
   ...
   * </ul>
   */
  getNotebook(authenticationToken: string, guid: string): Types_ttypes.Notebook;
   ...
   * </ul>
   */
  getNotebook(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Notebook)=>void): void;

  /**
   * Returns the notebook that should be used to store new notes in the
   * user's account when no other notebooks are specified.
   */
  getDefaultNotebook(authenticationToken: string): Types_ttypes.Notebook;

  /**
   * Returns the notebook that should be used to store new notes in the
   * user's account when no other notebooks are specified.
   */
  getDefaultNotebook(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.Notebook)=>void): void;
   ...
   * </ul>
   */
  createNotebook(authenticationToken: string, notebook: Types_ttypes.Notebook): Types_ttypes.Notebook;
   ...
   * </ul>
   */
  createNotebook(authenticationToken: string, notebook: Types_ttypes.Notebook, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Notebook)=>void): void;
   ...
   * </ul>
   */
  updateNotebook(authenticationToken: string, notebook: Types_ttypes.Notebook): number;
   ...
   * </ul>
   */
  updateNotebook(authenticationToken: string, notebook: Types_ttypes.Notebook, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  expungeNotebook(authenticationToken: string, guid: string): number;
   ...
   * </ul>
   */
  expungeNotebook(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   */
  listTags(authenticationToken: string): Types_ttypes.Tag[];

  /**
   * Returns a list of the tags in the account.  Evernote does not support
   * the undeletion of tags, so this will only include active tags.
   */
  listTags(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.Tag[])=>void): void;
   ...
   * </ul>
   */
  listTagsByNotebook(authenticationToken: string, notebookGuid: string): Types_ttypes.Tag[];
   ...
   * </ul>
   */
  listTagsByNotebook(authenticationToken: string, notebookGuid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Tag[])=>void): void;
   ...
   * </ul>
   */
  getTag(authenticationToken: string, guid: string): Types_ttypes.Tag;
   ...
   * </ul>
   */
  getTag(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Tag)=>void): void;
   ...
   * </ul>
   */
  createTag(authenticationToken: string, tag: Types_ttypes.Tag): Types_ttypes.Tag;
   ...
   * </ul>
   */
  createTag(authenticationToken: string, tag: Types_ttypes.Tag, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Tag)=>void): void;
   ...
   * </ul>
   */
  updateTag(authenticationToken: string, tag: Types_ttypes.Tag): number;
   ...
   * </ul>
   */
  updateTag(authenticationToken: string, tag: Types_ttypes.Tag, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  untagAll(authenticationToken: string, guid: string): void;
   ...
   * </ul>
   */
  untagAll(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: void)=>void): void;
   ...
   * </ul>
   */
  expungeTag(authenticationToken: string, guid: string): number;
   ...
   * </ul>
   */
  expungeTag(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   */
  listSearches(authenticationToken: string): Types_ttypes.SavedSearch[];

  /**
   * Returns a list of the searches in the account.  Evernote does not support
   * the undeletion of searches, so this will only include active searches.
   */
  listSearches(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.SavedSearch[])=>void): void;
   ...
   * </ul>
   */
  getSearch(authenticationToken: string, guid: string): Types_ttypes.SavedSearch;
   ...
   * </ul>
   */
  getSearch(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.SavedSearch)=>void): void;
   ...
   * </ul>
   */
  createSearch(authenticationToken: string, search: Types_ttypes.SavedSearch): Types_ttypes.SavedSearch;
   ...
   * </ul>
   */
  createSearch(authenticationToken: string, search: Types_ttypes.SavedSearch, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.SavedSearch)=>void): void;
   ...
   * </ul>
   */
  updateSearch(authenticationToken: string, search: Types_ttypes.SavedSearch): number;
   ...
   * </ul>
   */
  updateSearch(authenticationToken: string, search: Types_ttypes.SavedSearch, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  expungeSearch(authenticationToken: string, guid: string): number;
   ...
   * </ul>
   */
  expungeSearch(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  findNoteOffset(authenticationToken: string, filter: NoteFilter, guid: string): number;
   ...
   * </ul>
   */
  findNoteOffset(authenticationToken: string, filter: NoteFilter, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  findNotesMetadata(authenticationToken: string, filter: NoteFilter, offset: number, maxNotes: number, resultSpec: NotesMetadataResultSpec): NotesMetadataList;
   ...
   * </ul>
   */
  findNotesMetadata(authenticationToken: string, filter: NoteFilter, offset: number, maxNotes: number, resultSpec: NotesMetadataResultSpec, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: NotesMetadataList)=>void): void;
   ...
   * </ul>
   */
  findNoteCounts(authenticationToken: string, filter: NoteFilter, withTrash: boolean): NoteCollectionCounts;
   ...
   * </ul>
   */
  findNoteCounts(authenticationToken: string, filter: NoteFilter, withTrash: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: NoteCollectionCounts)=>void): void;
   ...
   * </ul>
   */
  getNoteWithResultSpec(authenticationToken: string, guid: string, resultSpec: NoteResultSpec): Types_ttypes.Note;
   ...
   * </ul>
   */
  getNoteWithResultSpec(authenticationToken: string, guid: string, resultSpec: NoteResultSpec, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Note)=>void): void;
   ...
   */
  getNote(authenticationToken: string, guid: string, withContent: boolean, withResourcesData: boolean, withResourcesRecognition: boolean, withResourcesAlternateData: boolean): Types_ttypes.Note;
   ...
   * populated on the returned note. To get a note with its shares, use getNoteWithResultSpec.
   */
  getNote(authenticationToken: string, guid: string, withContent: boolean, withResourcesData: boolean, withResourcesRecognition: boolean, withResourcesAlternateData: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Note)=>void): void;
   ...
   */
  getNoteApplicationData(authenticationToken: string, guid: string): Types_ttypes.LazyMap;
   ...
   * getNoteApplicationDataEntry instead.
   */
  getNoteApplicationData(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.LazyMap)=>void): void;
   ...
   * </ul>
   */
  getNoteApplicationDataEntry(authenticationToken: string, guid: string, key: string): string;
   ...
   * </ul>
   */
  getNoteApplicationDataEntry(authenticationToken: string, guid: string, key: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: string)=>void): void;

  /**
   * Update, or create, an entry in the applicationData map for
   * the note identified by guid.
   */
  setNoteApplicationDataEntry(authenticationToken: string, guid: string, key: string, value: string): number;

  /**
   * Update, or create, an entry in the applicationData map for
   * the note identified by guid.
   */
  setNoteApplicationDataEntry(authenticationToken: string, guid: string, key: string, value: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * non-existing key.
   */
  unsetNoteApplicationDataEntry(authenticationToken: string, guid: string, key: string): number;
   ...
   * non-existing key.
   */
  unsetNoteApplicationDataEntry(authenticationToken: string, guid: string, key: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  getNoteContent(authenticationToken: string, guid: string): string;
   ...
   * </ul>
   */
  getNoteContent(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: string)=>void): void;
   ...
   * </ul>
   */
  getNoteSearchText(authenticationToken: string, guid: string, noteOnly: boolean, tokenizeForIndexing: boolean): string;
   ...
   * </ul>
   */
  getNoteSearchText(authenticationToken: string, guid: string, noteOnly: boolean, tokenizeForIndexing: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: string)=>void): void;
   ...
   * </ul>
   */
  getResourceSearchText(authenticationToken: string, guid: string): string;
   ...
   * </ul>
   */
  getResourceSearchText(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: string)=>void): void;
   ...
   * </ul>
   */
  getNoteTagNames(authenticationToken: string, guid: string): string[];
   ...
   * </ul>
   */
  getNoteTagNames(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: string[])=>void): void;
   ...
   * </ul>
   */
  createNote(authenticationToken: string, note: Types_ttypes.Note): Types_ttypes.Note;
   ...
   * </ul>
   */
  createNote(authenticationToken: string, note: Types_ttypes.Note, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Note)=>void): void;
   ...
   * </ul>
   */
  updateNote(authenticationToken: string, note: Types_ttypes.Note): Types_ttypes.Note;
   ...
   * </ul>
   */
  updateNote(authenticationToken: string, note: Types_ttypes.Note, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Note)=>void): void;
   ...
   * </ul>
   */
  deleteNote(authenticationToken: string, guid: string): number;
   ...
   * </ul>
   */
  deleteNote(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  expungeNote(authenticationToken: string, guid: string): number;
   ...
   * </ul>
   */
  expungeNote(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  copyNote(authenticationToken: string, noteGuid: string, toNotebookGuid: string): Types_ttypes.Note;
   ...
   * </ul>
   */
  copyNote(authenticationToken: string, noteGuid: string, toNotebookGuid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Note)=>void): void;
   ...
   * </ul>
   */
  listNoteVersions(authenticationToken: string, noteGuid: string): NoteVersionId[];
   ...
   * </ul>
   */
  listNoteVersions(authenticationToken: string, noteGuid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: NoteVersionId[])=>void): void;
   ...
   * </ul>
   */
  getNoteVersion(authenticationToken: string, noteGuid: string, updateSequenceNum: number, withResourcesData: boolean, withResourcesRecognition: boolean, withResourcesAlternateData: boolean): Types_ttypes.Note;
   ...
   * </ul>
   */
  getNoteVersion(authenticationToken: string, noteGuid: string, updateSequenceNum: number, withResourcesData: boolean, withResourcesRecognition: boolean, withResourcesAlternateData: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Note)=>void): void;
   ...
   * </ul>
   */
  getResource(authenticationToken: string, guid: string, withData: boolean, withRecognition: boolean, withAttributes: boolean, withAlternateData: boolean): Types_ttypes.Resource;
   ...
   * </ul>
   */
  getResource(authenticationToken: string, guid: string, withData: boolean, withRecognition: boolean, withAttributes: boolean, withAlternateData: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Resource)=>void): void;
   ...
   */
  getResourceApplicationData(authenticationToken: string, guid: string): Types_ttypes.LazyMap;
   ...
   * getResourceApplicationDataEntry instead.
   */
  getResourceApplicationData(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.LazyMap)=>void): void;
   ...
   * </ul>
   */
  getResourceApplicationDataEntry(authenticationToken: string, guid: string, key: string): string;
   ...
   * </ul>
   */
  getResourceApplicationDataEntry(authenticationToken: string, guid: string, key: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: string)=>void): void;

  /**
   * Update, or create, an entry in the applicationData map for
   * the Resource identified by guid.
   */
  setResourceApplicationDataEntry(authenticationToken: string, guid: string, key: string, value: string): number;

  /**
   * Update, or create, an entry in the applicationData map for
   * the Resource identified by guid.
   */
  setResourceApplicationDataEntry(authenticationToken: string, guid: string, key: string, value: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;

  /**
   * Remove an entry identified by 'key' from the applicationData map for
   * the Resource identified by 'guid'.
   */
  unsetResourceApplicationDataEntry(authenticationToken: string, guid: string, key: string): number;

  /**
   * Remove an entry identified by 'key' from the applicationData map for
   * the Resource identified by 'guid'.
   */
  unsetResourceApplicationDataEntry(authenticationToken: string, guid: string, key: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  updateResource(authenticationToken: string, resource: Types_ttypes.Resource): number;
   ...
   * </ul>
   */
  updateResource(authenticationToken: string, resource: Types_ttypes.Resource, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: number)=>void): void;
   ...
   * </ul>
   */
  getResourceData(authenticationToken: string, guid: string): Buffer;
   ...
   * </ul>
   */
  getResourceData(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Buffer)=>void): void;
   ...
   * </ul>
   */
  getResourceByHash(authenticationToken: string, noteGuid: string, contentHash: Buffer, withData: boolean, withRecognition: boolean, withAlternateData: boolean): Types_ttypes.Resource;
   ...
   * </ul>
   */
  getResourceByHash(authenticationToken: string, noteGuid: string, contentHash: Buffer, withData: boolean, withRecognition: boolean, withAlternateData: boolean, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Resource)=>void): void;
   ...
   * </ul>
   */
  getResourceRecognition(authenticationToken: string, guid: string): Buffer;
   ...
   * </ul>
   */
  getResourceRecognition(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Buffer)=>void): void;
   ...
   * </ul>
   */
  getResourceAlternateData(authenticationToken: string, guid: string): Buffer;
   ...
   * </ul>
   */
  getResourceAlternateData(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Buffer)=>void): void;
   ...
   * </ul>
   */
  getResourceAttributes(authenticationToken: string, guid: string): Types_ttypes.ResourceAttributes;
   ...
   * </ul>
   */
  getResourceAttributes(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.ResourceAttributes)=>void): void;
   ...
   * </ul>
   */
  getPublicNotebook(userId: number, publicUri: string): Types_ttypes.Notebook;
   ...
   * </ul>
   */
  getPublicNotebook(userId: number, publicUri: string, callback: (error: Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: Types_ttypes.Notebook)=>void): void;
   ...
   * *   </ul>
   */
  shareNotebook(authenticationToken: string, sharedNotebook: Types_ttypes.SharedNotebook, message: string): Types_ttypes.SharedNotebook;
   ...
   * *   </ul>
   */
  shareNotebook(authenticationToken: string, sharedNotebook: Types_ttypes.SharedNotebook, message: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.SharedNotebook)=>void): void;
   ...
   * </ul>
   */
  createOrUpdateNotebookShares(authenticationToken: string, shareTemplate: NotebookShareTemplate): CreateOrUpdateNotebookSharesResult;
   ...
   * </ul>
   */
  createOrUpdateNotebookShares(authenticationToken: string, shareTemplate: NotebookShareTemplate, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMInvalidContactsException, response: CreateOrUpdateNotebookSharesResult)=>void): void;

  /**
   * @Deprecated See createOrUpdateNotebookShares and manageNotebookShares.
   */
  updateSharedNotebook(authenticationToken: string, sharedNotebook: Types_ttypes.SharedNotebook): number;

  /**
   * @Deprecated See createOrUpdateNotebookShares and manageNotebookShares.
   */
  updateSharedNotebook(authenticationToken: string, sharedNotebook: Types_ttypes.SharedNotebook, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: number)=>void): void;
   ...
   * </ul>
   */
  setNotebookRecipientSettings(authenticationToken: string, notebookGuid: string, recipientSettings: Types_ttypes.NotebookRecipientSettings): Types_ttypes.Notebook;
   ...
   * </ul>
   */
  setNotebookRecipientSettings(authenticationToken: string, notebookGuid: string, recipientSettings: Types_ttypes.NotebookRecipientSettings, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.Notebook)=>void): void;
   ...
   */
  listSharedNotebooks(authenticationToken: string): Types_ttypes.SharedNotebook[];
   ...
   *  The list of all SharedNotebooks for the user
   */
  listSharedNotebooks(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.SharedNotebook[])=>void): void;
   ...
   * </ul>
   */
  createLinkedNotebook(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook): Types_ttypes.LinkedNotebook;
   ...
   * </ul>
   */
  createLinkedNotebook(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.LinkedNotebook)=>void): void;
   ...
   * </ul>
   */
  updateLinkedNotebook(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook): number;
   ...
   * </ul>
   */
  updateLinkedNotebook(authenticationToken: string, linkedNotebook: Types_ttypes.LinkedNotebook, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: number)=>void): void;

  /**
   * Returns a list of linked notebooks
   */
  listLinkedNotebooks(authenticationToken: string): Types_ttypes.LinkedNotebook[];

  /**
   * Returns a list of linked notebooks
   */
  listLinkedNotebooks(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.LinkedNotebook[])=>void): void;
   ...
   *   from the account.
   */
  expungeLinkedNotebook(authenticationToken: string, guid: string): number;
   ...
   *   from the account.
   */
  expungeLinkedNotebook(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: number)=>void): void;
   ...
   * </ul>
   */
  authenticateToSharedNotebook(shareKeyOrGlobalId: string, authenticationToken: string): UserStore_ttypes.AuthenticationResult;
   ...
   * </ul>
   */
  authenticateToSharedNotebook(shareKeyOrGlobalId: string, authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: UserStore_ttypes.AuthenticationResult)=>void): void;
   ...
   * </ul>
   */
  getSharedNotebookByAuth(authenticationToken: string): Types_ttypes.SharedNotebook;
   ...
   * </ul>
   */
  getSharedNotebookByAuth(authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: Types_ttypes.SharedNotebook)=>void): void;
   ...
   * </ul>
   */
  emailNote(authenticationToken: string, parameters: NoteEmailParameters): void;
   ...
   * </ul>
   */
  emailNote(authenticationToken: string, parameters: NoteEmailParameters, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: void)=>void): void;
   ...
   * </ul>
   */
  shareNote(authenticationToken: string, guid: string): string;
   ...
   * </ul>
   */
  shareNote(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: string)=>void): void;
   ...
   * </ul>
   */
  stopSharingNote(authenticationToken: string, guid: string): void;
   ...
   * </ul>
   */
  stopSharingNote(authenticationToken: string, guid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: void)=>void): void;
   ...
   * </ul>
   */
  authenticateToSharedNote(guid: string, noteKey: string, authenticationToken: string): UserStore_ttypes.AuthenticationResult;
   ...
   * </ul>
   */
  authenticateToSharedNote(guid: string, noteKey: string, authenticationToken: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: UserStore_ttypes.AuthenticationResult)=>void): void;
   ...
   * </ul>
   */
  findRelated(authenticationToken: string, query: RelatedQuery, resultSpec: RelatedResultSpec): RelatedResult;
   ...
   * </ul>
   */
  findRelated(authenticationToken: string, query: RelatedQuery, resultSpec: RelatedResultSpec, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMSystemException | Errors_ttypes.EDAMNotFoundException, response: RelatedResult)=>void): void;
   ...
   * </ul>
   */
  updateNoteIfUsnMatches(authenticationToken: string, note: Types_ttypes.Note): UpdateNoteIfUsnMatchesResult;
   ...
   * </ul>
   */
  updateNoteIfUsnMatches(authenticationToken: string, note: Types_ttypes.Note, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: UpdateNoteIfUsnMatchesResult)=>void): void;
   ...
   * </ul>
   */
  manageNotebookShares(authenticationToken: string, parameters: ManageNotebookSharesParameters): ManageNotebookSharesResult;
   ...
   * </ul>
   */
  manageNotebookShares(authenticationToken: string, parameters: ManageNotebookSharesParameters, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: ManageNotebookSharesResult)=>void): void;
   ...
   * routine with the platform team.
   */
  getNotebookShares(authenticationToken: string, notebookGuid: string): ShareRelationships;
   ...
   * routine with the platform team.
   */
  getNotebookShares(authenticationToken: string, notebookGuid: string, callback: (error: Errors_ttypes.EDAMUserException | Errors_ttypes.EDAMNotFoundException | Errors_ttypes.EDAMSystemException, response: ShareRelationships)=>void): void;
}
...
declare class Processor {
  ...
  process_getSyncState(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getFilteredSyncChunk(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getLinkedNotebookSyncState(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getLinkedNotebookSyncChunk(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listNotebooks(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listAccessibleBusinessNotebooks(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getDefaultNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_createNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_expungeNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listTags(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listTagsByNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getTag(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_createTag(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateTag(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_untagAll(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_expungeTag(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listSearches(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getSearch(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_createSearch(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateSearch(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_expungeSearch(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_findNoteOffset(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_findNotesMetadata(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_findNoteCounts(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteWithResultSpec(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteApplicationData(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteApplicationDataEntry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_setNoteApplicationDataEntry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_unsetNoteApplicationDataEntry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteContent(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteSearchText(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceSearchText(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteTagNames(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_createNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_deleteNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_expungeNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_copyNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listNoteVersions(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNoteVersion(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResource(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceApplicationData(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceApplicationDataEntry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_setResourceApplicationDataEntry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_unsetResourceApplicationDataEntry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateResource(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceData(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceByHash(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceRecognition(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceAlternateData(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getResourceAttributes(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getPublicNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_shareNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_createOrUpdateNotebookShares(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateSharedNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_setNotebookRecipientSettings(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listSharedNotebooks(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_createLinkedNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateLinkedNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_listLinkedNotebooks(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_expungeLinkedNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_authenticateToSharedNotebook(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getSharedNotebookByAuth(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_emailNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_shareNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_stopSharingNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_authenticateToSharedNote(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_findRelated(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_updateNoteIfUsnMatches(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_manageNotebookShares(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
  process_getNotebookShares(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
