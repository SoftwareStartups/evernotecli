...
import sys
import evernote_mcp.edam.userstore.ttypes
import evernote_mcp.edam.type.ttypes
import evernote_mcp.edam.error.ttypes
import evernote_mcp.edam.limits.ttypes
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = evernote_mcp.edam.type.ttypes.Note()
                        _elem5.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i10 in range(_size6):
                        _elem11 = evernote_mcp.edam.type.ttypes.Notebook()
                        _elem11.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i16 in range(_size12):
                        _elem17 = evernote_mcp.edam.type.ttypes.Tag()
                        _elem17.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i22 in range(_size18):
                        _elem23 = evernote_mcp.edam.type.ttypes.SavedSearch()
                        _elem23.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i28 in range(_size24):
                        _elem29 = evernote_mcp.edam.type.ttypes.Resource()
                        _elem29.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i58 in range(_size54):
                        _elem59 = evernote_mcp.edam.type.ttypes.LinkedNotebook()
                        _elem59.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i95 in range(_size91):
                        _elem96 = evernote_mcp.edam.type.ttypes.Note()
                        _elem96.read(iprot)
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.attributes = evernote_mcp.edam.type.ttypes.NoteAttributes()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.note = evernote_mcp.edam.type.ttypes.Note()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i176 in range(_size172):
                        _elem177 = evernote_mcp.edam.type.ttypes.Note()
                        _elem177.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i182 in range(_size178):
                        _elem183 = evernote_mcp.edam.type.ttypes.Notebook()
                        _elem183.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i188 in range(_size184):
                        _elem189 = evernote_mcp.edam.type.ttypes.Tag()
                        _elem189.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i194 in range(_size190):
                        _elem195 = evernote_mcp.edam.type.ttypes.NotebookDescriptor()
                        _elem195.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        _elem201 = evernote_mcp.edam.type.ttypes.UserProfile()
                        _elem201.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i206 in range(_size202):
                        _elem207 = evernote_mcp.edam.type.ttypes.RelatedContent()
                        _elem207.read(iprot)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.recipientUserIdentity = evernote_mcp.edam.type.ttypes.UserIdentity()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i251 in range(_size247):
                        _elem252 = evernote_mcp.edam.type.ttypes.UserIdentity()
                        _elem252.read(iprot)
...
class ManageNotebookSharesError(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.userIdentity = evernote_mcp.edam.type.ttypes.UserIdentity()
                    self.userIdentity.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.userException = evernote_mcp.edam.error.ttypes.EDAMUserException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.notFoundException = evernote_mcp.edam.error.ttypes.EDAMNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i267 in range(_size263):
                        _elem268 = evernote_mcp.edam.type.ttypes.Contact()
                        _elem268.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i274 in range(_size270):
                        _elem275 = evernote_mcp.edam.type.ttypes.Contact()
                        _elem275.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i281 in range(_size277):
                        _elem282 = evernote_mcp.edam.type.ttypes.SharedNotebook()
                        _elem282.read(iprot)
...
SyncChunk.thrift_spec = (
    ...
    (3, TType.I32, 'updateCount', None, None, ),  # 3
    (4, TType.LIST, 'notes', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Note, None], False), None, ),  # 4
    (5, TType.LIST, 'notebooks', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Notebook, None], False), None, ),  # 5
    (6, TType.LIST, 'tags', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Tag, None], False), None, ),  # 6
    (7, TType.LIST, 'searches', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.SavedSearch, None], False), None, ),  # 7
    (8, TType.LIST, 'resources', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Resource, None], False), None, ),  # 8
    ...
    (13, TType.LIST, 'linkedNotebooks', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.LinkedNotebook, None], False), None, ),  # 13
...
NoteList.thrift_spec = (
    ...
    (3, TType.LIST, 'notes', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Note, None], False), None, ),  # 3
...
NoteMetadata.thrift_spec = (
    ...
    None,  # 13
    (14, TType.STRUCT, 'attributes', [evernote_mcp.edam.type.ttypes.NoteAttributes, None], None, ),  # 14
    None,  # 15
    None,  # 16
    None,  # 17
    None,  # 18
...
NoteEmailParameters.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'guid', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'note', [evernote_mcp.edam.type.ttypes.Note, None], None, ),  # 2
...
RelatedResult.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'notes', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Note, None], False), None, ),  # 1
    (2, TType.LIST, 'notebooks', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Notebook, None], False), None, ),  # 2
    (3, TType.LIST, 'tags', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Tag, None], False), None, ),  # 3
    (4, TType.LIST, 'containingNotebooks', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.NotebookDescriptor, None], False), None, ),  # 4
    (5, TType.STRING, 'debugInfo', 'UTF8', None, ),  # 5
    (6, TType.LIST, 'experts', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.UserProfile, None], False), None, ),  # 6
    (7, TType.LIST, 'relatedContent', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.RelatedContent, None], False), None, ),  # 7
...
UpdateNoteIfUsnMatchesResult.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'note', [evernote_mcp.edam.type.ttypes.Note, None], None, ),  # 1
...
InvitationShareRelationship.thrift_spec = (
    ...
    (2, TType.STRUCT, 'recipientUserIdentity', [evernote_mcp.edam.type.ttypes.UserIdentity, None], None, ),  # 2
...
ManageNotebookSharesParameters.thrift_spec = (
    ...
    (5, TType.LIST, 'unshares', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.UserIdentity, None], False), None, ),  # 5
)
all_structs.append(ManageNotebookSharesError)
ManageNotebookSharesError.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'userIdentity', [evernote_mcp.edam.type.ttypes.UserIdentity, None], None, ),  # 1
    (2, TType.STRUCT, 'userException', [evernote_mcp.edam.error.ttypes.EDAMUserException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_mcp.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
...
SharedNoteTemplate.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'noteGuid', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'recipientContacts', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.Contact, None], False), None, ),  # 2
    (3, TType.I32, 'privilege', None, None, ),  # 3
...
CreateOrUpdateNotebookSharesResult.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'updateSequenceNum', None, None, ),  # 1
    (2, TType.LIST, 'matchingShares', (TType.STRUCT, [evernote_mcp.edam.type.ttypes.SharedNotebook, None], False), None, ),  # 2
)
...
ManageNoteSharesError.thrift_spec = (
    ...
    (3, TType.STRUCT, 'userException', [evernote_mcp.edam.error.ttypes.EDAMUserException, None], None, ),  # 3
    (4, TType.STRUCT, 'notFoundException', [evernote_mcp.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 4
)
