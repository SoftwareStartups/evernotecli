...
import evernote_client.edam.error.ttypes
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = evernote_client.edam.type.ttypes.Note()
                        _elem5.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i10 in range(_size6):
                        _elem11 = evernote_client.edam.type.ttypes.Notebook()
                        _elem11.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i16 in range(_size12):
                        _elem17 = evernote_client.edam.type.ttypes.Tag()
                        _elem17.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i22 in range(_size18):
                        _elem23 = evernote_client.edam.type.ttypes.SavedSearch()
                        _elem23.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i28 in range(_size24):
                        _elem29 = evernote_client.edam.type.ttypes.Resource()
                        _elem29.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i58 in range(_size54):
                        _elem59 = evernote_client.edam.type.ttypes.LinkedNotebook()
                        _elem59.read(iprot)
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.requireNoteContentClass = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 15:
                if ftype == TType.SET:
...
class NoteFilter(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.words = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.emphasized = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.BOOL:
                ...
                if ftype == TType.BOOL:
                    self.includeAllReadableWorkspaces = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.rawWords = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.STRING:
                    self.searchContextBytes = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.context is not None:
            ...
            oprot.writeFieldEnd()
        if self.rawWords is not None:
            oprot.writeFieldBegin('rawWords', TType.STRING, 11)
            oprot.writeString(self.rawWords.encode('utf-8') if sys.version_info[0] == 2 else self.rawWords)
            oprot.writeFieldEnd()
        if self.searchContextBytes is not None:
            oprot.writeFieldBegin('searchContextBytes', TType.STRING, 12)
            oprot.writeBinary(self.searchContextBytes)
            oprot.writeFieldEnd()
        if self.includeAllReadableWorkspaces is not None:
            oprot.writeFieldBegin('includeAllReadableWorkspaces', TType.BOOL, 15)
            oprot.writeBool(self.includeAllReadableWorkspaces)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class NoteList(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i95 in range(_size91):
                        _elem96 = evernote_client.edam.type.ttypes.Note()
                        _elem96.read(iprot)
    ...
    def write(self, oprot):
        ...
        if self.updateCount is not None:
            ...
            oprot.writeFieldEnd()
        if self.searchContextBytes is not None:
            oprot.writeFieldBegin('searchContextBytes', TType.STRING, 7)
            oprot.writeBinary(self.searchContextBytes)
            oprot.writeFieldEnd()
        if self.debugInfo is not None:
            oprot.writeFieldBegin('debugInfo', TType.STRING, 8)
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.attributes = evernote_client.edam.type.ttypes.NoteAttributes()
                    self.attributes.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 20:
                if ftype == TType.STRING:
                    self.largestResourceMime = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 21:
                if ftype == TType.I32:
...
class NotesMetadataList(object):
    ...
    def write(self, oprot):
        ...
        if self.searchContextBytes is not None:
            ...
            oprot.writeFieldEnd()
        if self.debugInfo is not None:
            oprot.writeFieldBegin('debugInfo', TType.STRING, 9)
            oprot.writeString(self.debugInfo.encode('utf-8') if sys.version_info[0] == 2 else self.debugInfo)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.note = evernote_client.edam.type.ttypes.Note()
                ...
                if ftype == TType.LIST:
                    ...
                    for _i168 in range(_size164):
                        _elem169 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.plainText = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                ...
                if ftype == TType.STRING:
                    self.referenceUri = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.cacheKey = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i176 in range(_size172):
                        _elem177 = evernote_client.edam.type.ttypes.Note()
                        _elem177.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i182 in range(_size178):
                        _elem183 = evernote_client.edam.type.ttypes.Notebook()
                        _elem183.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i188 in range(_size184):
                        _elem189 = evernote_client.edam.type.ttypes.Tag()
                        _elem189.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i194 in range(_size190):
                        _elem195 = evernote_client.edam.type.ttypes.NotebookDescriptor()
                        _elem195.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        _elem201 = evernote_client.edam.type.ttypes.UserProfile()
                        _elem201.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i206 in range(_size202):
                        _elem207 = evernote_client.edam.type.ttypes.RelatedContent()
                        _elem207.read(iprot)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.recipientUserIdentity = evernote_client.edam.type.ttypes.UserIdentity()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.inviteMessage = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i251 in range(_size247):
                        _elem252 = evernote_client.edam.type.ttypes.UserIdentity()
                        _elem252.read(iprot)
...
class ManageNotebookSharesError(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.userIdentity = evernote_client.edam.type.ttypes.UserIdentity()
                    self.userIdentity.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.userException = evernote_client.edam.error.ttypes.EDAMUserException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.notFoundException = evernote_client.edam.error.ttypes.EDAMNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i267 in range(_size263):
                        _elem268 = evernote_client.edam.type.ttypes.Contact()
                        _elem268.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i274 in range(_size270):
                        _elem275 = evernote_client.edam.type.ttypes.Contact()
                        _elem275.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i281 in range(_size277):
                        _elem282 = evernote_client.edam.type.ttypes.SharedNotebook()
                        _elem282.read(iprot)
...
SyncChunk.thrift_spec = (
    ...
    (3, TType.I32, 'updateCount', None, None, ),  # 3
    (4, TType.LIST, 'notes', (TType.STRUCT, [evernote_client.edam.type.ttypes.Note, None], False), None, ),  # 4
    (5, TType.LIST, 'notebooks', (TType.STRUCT, [evernote_client.edam.type.ttypes.Notebook, None], False), None, ),  # 5
    (6, TType.LIST, 'tags', (TType.STRUCT, [evernote_client.edam.type.ttypes.Tag, None], False), None, ),  # 6
    (7, TType.LIST, 'searches', (TType.STRUCT, [evernote_client.edam.type.ttypes.SavedSearch, None], False), None, ),  # 7
    (8, TType.LIST, 'resources', (TType.STRUCT, [evernote_client.edam.type.ttypes.Resource, None], False), None, ),  # 8
    ...
    (13, TType.LIST, 'linkedNotebooks', (TType.STRUCT, [evernote_client.edam.type.ttypes.LinkedNotebook, None], False), None, ),  # 13
...
NoteFilter.thrift_spec = (
    ...
    (11, TType.STRING, 'rawWords', 'UTF8', None, ),  # 11
    (12, TType.STRING, 'searchContextBytes', 'BINARY', None, ),  # 12
    None,  # 13
    None,  # 14
    (15, TType.BOOL, 'includeAllReadableWorkspaces', None, None, ),  # 15
)
...
NoteList.thrift_spec = (
    ...
    (3, TType.LIST, 'notes', (TType.STRUCT, [evernote_client.edam.type.ttypes.Note, None], False), None, ),  # 3
    ...
    (7, TType.STRING, 'searchContextBytes', 'BINARY', None, ),  # 7
    (8, TType.STRING, 'debugInfo', 'UTF8', None, ),  # 8
)
...
NoteMetadata.thrift_spec = (
    ...
    None,  # 13
    (14, TType.STRUCT, 'attributes', [evernote_client.edam.type.ttypes.NoteAttributes, None], None, ),  # 14
    None,  # 15
    None,  # 16
    None,  # 17
    None,  # 18
...
NotesMetadataList.thrift_spec = (
    ...
    (7, TType.STRING, 'searchContextBytes', 'BINARY', None, ),  # 7
    None,  # 8
    (9, TType.STRING, 'debugInfo', 'UTF8', None, ),  # 9
)
...
NoteEmailParameters.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'guid', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'note', [evernote_client.edam.type.ttypes.Note, None], None, ),  # 2
...
RelatedResult.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'notes', (TType.STRUCT, [evernote_client.edam.type.ttypes.Note, None], False), None, ),  # 1
    (2, TType.LIST, 'notebooks', (TType.STRUCT, [evernote_client.edam.type.ttypes.Notebook, None], False), None, ),  # 2
    (3, TType.LIST, 'tags', (TType.STRUCT, [evernote_client.edam.type.ttypes.Tag, None], False), None, ),  # 3
    (4, TType.LIST, 'containingNotebooks', (TType.STRUCT, [evernote_client.edam.type.ttypes.NotebookDescriptor, None], False), None, ),  # 4
    (5, TType.STRING, 'debugInfo', 'UTF8', None, ),  # 5
    (6, TType.LIST, 'experts', (TType.STRUCT, [evernote_client.edam.type.ttypes.UserProfile, None], False), None, ),  # 6
    (7, TType.LIST, 'relatedContent', (TType.STRUCT, [evernote_client.edam.type.ttypes.RelatedContent, None], False), None, ),  # 7
...
UpdateNoteIfUsnMatchesResult.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'note', [evernote_client.edam.type.ttypes.Note, None], None, ),  # 1
...
InvitationShareRelationship.thrift_spec = (
    ...
    (2, TType.STRUCT, 'recipientUserIdentity', [evernote_client.edam.type.ttypes.UserIdentity, None], None, ),  # 2
...
ManageNotebookSharesParameters.thrift_spec = (
    ...
    (5, TType.LIST, 'unshares', (TType.STRUCT, [evernote_client.edam.type.ttypes.UserIdentity, None], False), None, ),  # 5
)
all_structs.append(ManageNotebookSharesError)
ManageNotebookSharesError.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'userIdentity', [evernote_client.edam.type.ttypes.UserIdentity, None], None, ),  # 1
    (2, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
...
SharedNoteTemplate.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'noteGuid', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'recipientContacts', (TType.STRUCT, [evernote_client.edam.type.ttypes.Contact, None], False), None, ),  # 2
    (3, TType.I32, 'privilege', None, None, ),  # 3
...
CreateOrUpdateNotebookSharesResult.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'updateSequenceNum', None, None, ),  # 1
    (2, TType.LIST, 'matchingShares', (TType.STRUCT, [evernote_client.edam.type.ttypes.SharedNotebook, None], False), None, ),  # 2
)
...
ManageNoteSharesError.thrift_spec = (
    ...
    (3, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 3
    (4, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 4
)
