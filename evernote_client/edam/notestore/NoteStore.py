...
class Processor(Iface, TProcessor):
    ...
    def process_getSyncState(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except evernote_client.edam.error.ttypes.EDAMUserException as userException:
            msg_type = TMessageType.REPLY
            result.userException = userException
        except evernote_client.edam.error.ttypes.EDAMSystemException as systemException:
            msg_type = TMessageType.REPLY
    ...
    def process_getLinkedNotebookSyncState(self, seqid, iprot, oprot):
        ...
        try:
            ...
            msg_type = TMessageType.REPLY
            result.systemException = systemException
        except evernote_client.edam.error.ttypes.EDAMNotFoundException as notFoundException:
            msg_type = TMessageType.REPLY
    ...
    def process_createOrUpdateNotebookShares(self, seqid, iprot, oprot):
        ...
        try:
            ...
            msg_type = TMessageType.REPLY
            result.systemException = systemException
        except evernote_client.edam.error.ttypes.EDAMInvalidContactsException as invalidContactsException:
            msg_type = TMessageType.REPLY
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.systemException = evernote_client.edam.error.ttypes.EDAMSystemException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
getSyncState_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.linkedNotebook = evernote_client.edam.type.ttypes.LinkedNotebook()
...
getLinkedNotebookSyncState_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'linkedNotebook', [evernote_client.edam.type.ttypes.LinkedNotebook, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i337 in range(_size333):
                        _elem338 = evernote_client.edam.type.ttypes.Notebook()
                        _elem338.read(iprot)
...
listNotebooks_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.Notebook, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i344 in range(_size340):
                        _elem345 = evernote_client.edam.type.ttypes.Notebook()
                        _elem345.read(iprot)
...
class getNotebook_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.Notebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getNotebook_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.Notebook, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.notebook = evernote_client.edam.type.ttypes.Notebook()
...
createNotebook_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'notebook', [evernote_client.edam.type.ttypes.Notebook, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i351 in range(_size347):
                        _elem352 = evernote_client.edam.type.ttypes.Tag()
                        _elem352.read(iprot)
...
listTags_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.Tag, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i358 in range(_size354):
                        _elem359 = evernote_client.edam.type.ttypes.Tag()
                        _elem359.read(iprot)
...
class getTag_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.Tag()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getTag_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.Tag, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.tag = evernote_client.edam.type.ttypes.Tag()
                    self.tag.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
createTag_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'tag', [evernote_client.edam.type.ttypes.Tag, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i365 in range(_size361):
                        _elem366 = evernote_client.edam.type.ttypes.SavedSearch()
                        _elem366.read(iprot)
...
listSearches_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.SavedSearch, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
...
class getSearch_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.SavedSearch()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getSearch_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.SavedSearch, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.search = evernote_client.edam.type.ttypes.SavedSearch()
...
createSearch_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'search', [evernote_client.edam.type.ttypes.SavedSearch, None], None, ),  # 2
)
...
class getNoteWithResultSpec_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.Note()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getNoteWithResultSpec_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.Note, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
...
class getNoteApplicationData_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.LazyMap()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getNoteApplicationData_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.LazyMap, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
...
class getResource_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.Resource()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getResource_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.Resource, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.resource = evernote_client.edam.type.ttypes.Resource()
...
updateResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'resource', [evernote_client.edam.type.ttypes.Resource, None], None, ),  # 2
)
...
class getResourceAttributes_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.ResourceAttributes()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getResourceAttributes_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.ResourceAttributes, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
    (3, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 3
)
...
getPublicNotebook_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.Notebook, None], None, ),  # 0
    (1, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 1
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.sharedNotebook = evernote_client.edam.type.ttypes.SharedNotebook()
...
shareNotebook_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'sharedNotebook', [evernote_client.edam.type.ttypes.SharedNotebook, None], None, ),  # 2
...
class shareNotebook_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.SharedNotebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
shareNotebook_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.SharedNotebook, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
    (3, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 3
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.invalidContactsException = evernote_client.edam.error.ttypes.EDAMInvalidContactsException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
createOrUpdateNotebookShares_result.thrift_spec = (
    ...
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
    (3, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 3
    (4, TType.STRUCT, 'invalidContactsException', [evernote_client.edam.error.ttypes.EDAMInvalidContactsException, None], None, ),  # 4
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.recipientSettings = evernote_client.edam.type.ttypes.NotebookRecipientSettings()
...
setNotebookRecipientSettings_args.thrift_spec = (
    ...
    (1, TType.STRING, 'authenticationToken', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'notebookGuid', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'recipientSettings', [evernote_client.edam.type.ttypes.NotebookRecipientSettings, None], None, ),  # 3
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i386 in range(_size382):
                        _elem387 = evernote_client.edam.type.ttypes.SharedNotebook()
                        _elem387.read(iprot)
...
listSharedNotebooks_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.SharedNotebook, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
    (3, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 3
)
...
class createLinkedNotebook_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.LinkedNotebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
createLinkedNotebook_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.LinkedNotebook, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
    (3, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 3
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i393 in range(_size389):
                        _elem394 = evernote_client.edam.type.ttypes.LinkedNotebook()
                        _elem394.read(iprot)
...
listLinkedNotebooks_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.LinkedNotebook, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
    (3, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 3
)
...
class authenticateToSharedNotebook_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.userstore.ttypes.AuthenticationResult()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
authenticateToSharedNotebook_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.userstore.ttypes.AuthenticationResult, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 2
    (3, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 3
)
