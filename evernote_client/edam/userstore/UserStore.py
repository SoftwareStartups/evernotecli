...
class getUser_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.User()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getUser_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.User, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
...
getPublicUserInfo_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'notFoundException', [evernote_client.edam.error.ttypes.EDAMNotFoundException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        _elem12 = evernote_client.edam.type.ttypes.UserProfile()
                        _elem12.read(iprot)
...
listBusinessUsers_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.UserProfile, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i18 in range(_size14):
                        _elem19 = evernote_client.edam.type.ttypes.BusinessInvitation()
                        _elem19.read(iprot)
...
listBusinessInvitations_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [evernote_client.edam.type.ttypes.BusinessInvitation, None], False), None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
    (2, TType.STRUCT, 'systemException', [evernote_client.edam.error.ttypes.EDAMSystemException, None], None, ),  # 2
)
...
class getAccountLimits_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = evernote_client.edam.type.ttypes.AccountLimits()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
getAccountLimits_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [evernote_client.edam.type.ttypes.AccountLimits, None], None, ),  # 0
    (1, TType.STRUCT, 'userException', [evernote_client.edam.error.ttypes.EDAMUserException, None], None, ),  # 1
)
